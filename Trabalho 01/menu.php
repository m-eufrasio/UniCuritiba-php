        ...
        <div class="painelMenu">
            <div class="menu">
                ...
                <?php if ($_SESSION["UsuarioNivel"] == "ADM") { ?>
                    ...
                    <button onclick="window.location.href = 'liberar_anuncios.php'" class="btnCadastrar"> Liberar Anuncios </button>
                ...
                <button onclick="window.location.href = 'anuncios.php'" class="btnRelatorio"> Ver Anuncios </button>

                <button onclick="window.location.href = 'meus_anuncios.php'" class="btnRelatorio"> Meus Anuncios </button>
